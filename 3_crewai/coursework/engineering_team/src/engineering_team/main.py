...
import engineering_team.patch  # noqa: F401 — MCP tool-name fix
from engineering_team.crew import EngineeringTeam
from engineering_team.env import load_project_env
from engineering_team.tools.sandbox_tools import prepare_sandbox_for_crew
...
def run():
    """Run the crew."""
    load_project_env()
    prep = prepare_sandbox_for_crew()
    inputs = {
        "requirements": requirements,
        "sandbox_status": prep["sandbox_status"],
        "podman_status": prep["podman_status"],
    }
